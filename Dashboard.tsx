    ...
    <>
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 border border-transparent ${
                isActive 
      ...
      <div className="mt-8 pt-6 border-t border-white/10">
        <button
          ...
          className="flex items-center gap-3 px-4 py-3 w-full rounded-lg text-red-400 hover:bg-red-400/10 hover:text-red-300 transition-colors duration-200"
        >
          <LogOut size={20} />
    ...
    <div className="flex h-screen bg-background overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden relative z-10 w-full">
        ...
        <main className="flex-1 overflow-y-auto w-full flex justify-center">
            ...
            <div className="w-full max-w-7xl px-4 sm:px-6 md:px-8 py-8 md:py-10 pb-24">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 w-72 bg-card border-r border-white/5 p-6 z-50 flex flex-col md:hidden"
            >
              <SidebarContent />
            </motion.aside>
          </>
